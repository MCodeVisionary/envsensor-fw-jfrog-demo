/*
 * Dummy placeholder — NOT real POCO source.
 *
 * Exists only so scripts/xray_scan.sh can declare a dependency on
 * poco:1.9.0.0 in the generated Xray build-info, matching the component ID
 * used in JFrog's public C/C++ Xray scanning reference:
 ...
 */
int envsensor_fw_poco_stub_marker(void) {
    return 0;
}
